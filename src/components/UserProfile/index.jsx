        ...
        <div className="container mx-auto grid grid-cols-12 mt-10">
            <div className="col-span-12 grid grid-cols-12 bg-grey-light rounded-md py-8 px-4 xl:px-2">
                ...
                <div className="col-span-12 sm:col-span-8 lg:col-span-5 xl:col-span-4 flex flex-col justify-center items-center sm:items-start mt-4 sm:mt-0">
                    <div className="flex items-center text-black ctext-lg font-bold">Адбуллаев Абдулазиз Абдуллаевич <BiPencil className="cursor-pointer ml-2 text-blue text-xl" /></div>
                    ...
                    <div className="flex items-center flex-col sm:flex-row text-black mt-2 ctext-base font-medium"><div>Телефон: <span className="text-grey ml-2">+998 94 616 75 39</span></div><button className="text-white ctext-xs font-bold bg-blue py-2 px-4 rounded-md sm:ml-2 mt-2 sm:mt-0 focus:outline-none">Привязать другой</button></div>
                </div>
                ...
                <div className="col-span-12 order-last xl:order-none xl:col-span-3 py-4">
                    <div className="xl:border-l border-grey xl:pl-4 h-full flex flex-col justify-center items-center xl:items-start">
                        ...
                        <button className="text-white ctext-base font-bold py-2 px-4 mt-4 bg-blue rounded-md focus:outline-none">Пополнить баланс</button>
                    </div>
                </div>
                {/* log-out */}
