...
const ChangeName = () => {
    ...
    return (
        <div className={`fixed ${newName ? 'top-0' : '-top-full'} transition-all w-full h-full bg-white sm:bg-black-black sm:bg-opacity-30 flex justify-center items-center z-40`}>
            <AiOutlineClose
