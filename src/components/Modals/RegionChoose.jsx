...
const RegionChoose = () => {
    ...
    return (
        <div 
            ...
            style={{translateY: regionChoose ? '0' : '1000px'}}
            className={`fixed top-0  transform transition-all w-full h-full bg-white sm:bg-black-black sm:bg-opacity-30 flex justify-center items-center z-100`}>
            <AiOutlineClose
