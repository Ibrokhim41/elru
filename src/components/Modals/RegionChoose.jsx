...
const RegionChoose = () => {
    ...
    return (
        <div className={`fixed top-0 ${regionChoose ? 'translate-y-0' : 'translate-y-full hidden'} transform transition-all w-full h-full bg-white sm:bg-black-black sm:bg-opacity-30 flex justify-center items-center z-100`}>
            <AiOutlineClose
